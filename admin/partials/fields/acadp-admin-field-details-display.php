...
<table class="acadp-input widefat" id="acadp-field-details">
  <tbody>
    <tr class="field-type">
      ...
      <td>
        <?php $selected_type = isset( $post_meta['type'] ) ? $post_meta['type'][0] : 'text'; ?>
        <select class="select" name="type">
          <option value="text" <?php echo selected( $selected_type, 'text', false ); ?>><?php _e( 'Text', 'advanced-classifieds-and-directory-pro' ); ?></option>
          <option value="textarea" <?php echo selected( $selected_type, 'textarea', false ); ?>><?php _e( 'Text Area', 'advanced-classifieds-and-directory-pro' ); ?></option>
          <option value="select" <?php echo selected( $selected_type, 'select', false ); ?>><?php _e( 'Select', 'advanced-classifieds-and-directory-pro' ); ?></option>
          <option value="checkbox" <?php echo selected( $selected_type, 'checkbox', false ); ?>><?php _e( 'Checkbox', 'advanced-classifieds-and-directory-pro' ); ?></option>
          <option value="radio" <?php echo selected( $selected_type, 'radio', false ); ?>><?php _e( 'Radio Button', 'advanced-classifieds-and-directory-pro' ); ?></option>
          <option value="url" <?php echo selected( $selected_type, 'url', false ); ?>><?php _e( 'URL', 'advanced-classifieds-and-directory-pro' ); ?></option>
        </select>
      </td>
    </tr>
