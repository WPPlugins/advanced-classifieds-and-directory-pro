...
class ACADP_Admin_Listings {
	...
	public function restrict_manage_posts() {
		...
		if( 'acadp_listings' == $typenow ) {
			...
			if( ! empty( $featured_settings['enabled'] ) ) {
	...
	public function get_columns( $columns ) {
		...
		$new_columns = array(
			...
			'posted_date' => __( 'Posted Date', 'advanced-classifieds-and-directory-pro' ),
			'expiry_date' => __( 'Expires on', 'advanced-classifieds-and-directory-pro' ),
